...
def main():
    ...
    if not args.azure:
        ...
        dataset_name = "zephyr_7b_train_dataset"
        dataset_version = "1"
        docker_context_path = "finetuning/docker-contexts/wais_zephyr_7b_env"
        ...
        azure_environment_name = "wais_zephyr_7b_env"
        ...
        env_docker_context = Environment(
            ...
            description="Environment created from a Docker context for training zephyr_7b model using Olive.",
        )
