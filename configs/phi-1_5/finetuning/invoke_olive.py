...
def main():
    ...
    if not args.azure:
        ...
        dataset_name = "phi15_train_dataset"
        dataset_version = "1"
        docker_context_path = "finetuning/docker-contexts/wais_phi15_env"
        ...
        azure_environment_name = "wais_phi15_env"
        ...
        env_docker_context = Environment(
            ...
            description="Environment created from a Docker context for training phi15 model using Olive.",
        )
